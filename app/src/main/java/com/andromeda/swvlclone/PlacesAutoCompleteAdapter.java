...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FOOTER_VIEW) {
            ...
            int layout = R.layout.item_address;
...
//        @BindView(R.id.current_location_address)
        TextView place_name;

//        @BindView(R.id.current_location_address_two)
        TextView placeAddress;


        PlacesViewHolder(@NonNull View itemView) {
            super(itemView);
            place_name = itemView.findViewById(R.id.current_location_address);
            placeAddress = itemView.findViewById(R.id.current_location_address_two);
